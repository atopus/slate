...
class Playground extends React.Component {
  ...
  /**
   * Check if any of the currently selected blocks are of `type`.
   *
   * @param {String} type
   * @return {Boolean}
   */
  ...
  /**
   * Check if any of the currently selected inlines are of `type`
   * 
   * @param {String} type
   * @return {Boolean}
   */
  ...
  renderNode = props => {
    ...
    switch (node.type) {
      ...
      case 'card':
        return <div className='card' {...attributes}>{children}</div>
    }
  }
